...
const ProductDetail = () => {
  ...
  // add to cart
  const addtoCart = () => {
    // Retrieve existing cart items from localStorage or initialize with an empty array
    const cartItems = JSON.parse(localStorage.getItem("cartitems")) || [];

    // Define the product item to add
    const productItem = {
      id: product._id,
    ...
    if (existingItem) {
      ...
      toast.success(
        `${product.product_name} is added to your cart successfully.`
      );
    }
  };
      ...
      <div className="bg-grey-100">
        <div className="container mx-auto px-4 py-8">
          <div className="flex flex-wrap -mx-4">
            <div className="w-1/2 md:w-1/2  flex items-center justify-center flex-col px-4 sm:mb-36  md:mb-36">
              <img
                src={`http://localhost:8181/${product.product_image}`}
            ...
            <div className="w-full md:w-1/2 px-4">
              ...
              <div className="mb-6">
                ...
                <div className="flex space-x-2">
                  ...
                  <button className="w-8 h-8 bg-pink-700 rounded-full focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500"></button>
                </div>
              </div>
              ...
              <div className="mb-6">
                ...
                <input
                  ...
                  className="w-12 text-center rounded-md border-gray-300  shadow-sm focus:border-pink-300 focus:ring focus:ring-pink-200 focus:ring-opacity-50"
                />
              </div>
              ...
              <div className="flex space-x-4 mb-6">
                <button
                  onClick={addtoCart}
                  className="bg-pink-600 flex gap-2 items-center text-white px-6 py-2 rounded-md hover:bg-pink-700 focus:outline-none focus:ring-2 focus:ring-pink-500 focus:ring-offset-2"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    fill="none"
              ...
              <div>
                ...
                <ul className="list-disc list-inside text-gray-700  md:mb-10">

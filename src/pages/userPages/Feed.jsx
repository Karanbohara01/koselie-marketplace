...
const Feed = () => {
  return (
    <>
      ...
      >
        <div className="h-full px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-gray-800">
          <Link to="" className="flex items-center ps-2.5 mb-5">
            <img
              className="h-10 -px-14 w-10 rounded-full"
          ...
          <ul className="space-y-2 font-medium">
            ...
            <li>
              ...
              >
                ...
                <span className="flex-1 ms-3 whitespace-nowrap">Video</span>
              </Link>
            </li>
            <li>
              <Link
            ...
            <li>
              ...
              >
                <StarIcon className="w-5 h-5" />
                <span className="flex-1 ms-3 whitespace-nowrap">See more</span>
              </Link>
            </li>
            <li>
              <Link
      ...
      <div className="p-4  bg-red-700 sm:ml-64">
        <div className="p-4 mb-20 border-2 border-gray-200 border-dashed rounded-lg dark:border-gray-700">
          <Outlet />
        </div>
      </div>
    </>
